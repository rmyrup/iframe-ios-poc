(function e(t, n, r) {
    ...
    1: [function(require, module, exports) {
        ...
        require('inkling-widget-api/container/view')(window, {
            apiRegistry: apiRegistry
        });
        require('inkling-widget-api/container/message')(window, {
            apiRegistry: apiRegistry
        });
        require('inkling-widget-api/container/link')(window, {
            apiRegistry: apiRegistry
        });
        ...
        "inkling-widget-api/container/availability": 2,
        "inkling-widget-api/container/link": 3,
        "inkling-widget-api/container/message": 4,
        "inkling-widget-api/container/orientation": 5,
        "inkling-widget-api/container/params": 6,
        "inkling-widget-api/container/view": 7
    }],
    ...
    3: [function(require, module, exports) {
        ...
        function ContainerLinkAPI(window, options) {
            ...
            if (options.apiRegistry) {
                options.apiRegistry.registerAPI('link', {
                    open: true
                });
            }
        }
    ...
    5: [function(require, module, exports) {
        ...
        function ContainerOrientationAPI(window, options) {
            ...
            if (options.apiRegistry) {
                options.apiRegistry.registerAPI('orientation', {
    ...
    7: [function(require, module, exports) {
        ...
        function ContainerViewAPI(window, options) {
            ...
            if (options.apiRegistry) {
                options.apiRegistry.registerAPI('view', {
                    set: true
                });
            }
        }
